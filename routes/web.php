...
Route::get('portal/timeline', 'PortalController@timeline')->name('portal.timeline')->middleware('user');
...
Route::get('map', 'MapController@index')->name('map.index')->middleware('user');
Route::get('map/location', 'MapController@location')->name('map.location')->middleware('user');
Route::put('map/location', 'MapController@store')->name('map.store')->middleware('user');
Route::post('map/check', 'MapController@check_shipping')->name('map.check')->middleware('user');
Route::get('map/get', 'MapController@get')->name('map.get')->middleware('user');
Auth::routes();
